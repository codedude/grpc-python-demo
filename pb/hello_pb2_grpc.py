...
from pb import hello_pb2 as pb_dot_hello__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in pb/hello_pb2_grpc.py depends on'
...
class HelloStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/Hello/SayHello',
                request_serializer=pb_dot_hello__pb2.HelloRequest.SerializeToString,
                response_deserializer=pb_dot_hello__pb2.HelloResponse.FromString,
...
class Hello(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Hello/SayHello',
            pb_dot_hello__pb2.HelloRequest.SerializeToString,
            pb_dot_hello__pb2.HelloResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
